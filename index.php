...
//			require_once "DBConnect.php";
	...
	<!-- TA -->
		<div style="text-align:center;">
			...
			<div class="container" id="extendedStats"> <!-- Extended Stats -->
				 <!-- Extended Stats tabs -->
				  ...
				  <!-- Tab panes -->
				  <div class="tab-content"> <!-- Wait time graphs -->
						...
						<div id="graphsContent">
							...
							<div class="row">
								<div style="text-align:center;">
									...
									<center><div id="rawGraphData"></div></center>
								</div>
							</div>
						</div>
					</div>

					<div role="tabpanel" class="tab-pane" id="tables"> <!-- TA to Student Help Table -->
						<div class="row">
							<br/>
					...
					<div role="tabpanel" class="tab-pane" id="questionsTab"> <!-- Qustions Table -->
						<div class="row">
							<br/>
					...
					<div role="tabpanel" class="tab-pane" id="profileTab"> <!-- Student Profile -->
						...
						<br/><center><h4>TA Help Counts</h4></center><br/>
						<div class="row">
							<div id="profileTAHelpCount"></div>
						</div>
						<br/><center><h4>Questions asked</h4></center><br/>
						<div class="row">
